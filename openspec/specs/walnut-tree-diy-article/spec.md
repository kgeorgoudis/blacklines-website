# Spec: walnut-tree-diy-article

## Purpose

A Hugo content page under the DIY section documenting the creation of a walnut live-edge table and two rooftop pendant lights from cross-section slabs salvaged from a village walnut tree.
...
The article SHALL include all 12 photos from the source directory, organized inline throughout the text so that each image appears near the content it illustrates (not grouped at the end in a separate gallery).
